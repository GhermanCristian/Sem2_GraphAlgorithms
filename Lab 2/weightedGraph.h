...
#define GRAPH_10K_WEIGHTED_ORIENTED "graph10k_w.txt"
#define GRAPH_100K_WEIGHTED_ORIENTED "graph100k_w.txt"
#define GRAPH_1K_WEIGHTED_UNORIENTED "graph1k_w_uno.txt"

#define CURRENT_WEIGHTED_ORIENTED_GRAPH_FILE GRAPH_10K_WEIGHTED_ORIENTED
